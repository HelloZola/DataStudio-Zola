...
cp $SOURCE/3rd_src/target/dependency/javafx-base-17.0.2.jar $DEST/org.opengauss.mppdbide.view/.
cp $SOURCE/3rd_src/target/dependency/javafx-controls-17.0.2.jar $DEST/org.opengauss.mppdbide.view/.
cp $SOURCE/3rd_src/target/dependency/javafx-graphics-17.0.2.jar $DEST/org.opengauss.mppdbide.view/.
