...
import org.opengauss.mppdbide.adapter.factory.DBConnectionFactory;
import org.opengauss.mppdbide.adapter.gauss.DBConnection;
import org.opengauss.mppdbide.adapter.gauss.GaussUtils;
import org.opengauss.mppdbide.adapter.gauss.ObjectBrowserDBConnection;
...
public class ConnectionManager {
    ...
    private static class TerminalConnectionPoolManager {
        ...
        public void releaseConnection(DBConnection conn,
                org.opengauss.mppdbide.bl.serverdatacache.savepsswordoption.SavePrdOptions savePrdOption) {
            boolean isRemoved = false;
            synchronized (poolLock) {
